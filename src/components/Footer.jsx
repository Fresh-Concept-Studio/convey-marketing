          ...
          <div>
            <div className="flex items-center text-gray-900">
              <div className="ml-4">
                ...
                <path fillRule="evenodd" clip-ruleRule="evenodd" d="M11.4436 17.8013C14.9548 17.8013 17.8012 14.9549 17.8012 11.4437C17.8012 7.93252 14.9548 5.08612 11.4436 5.08612C7.9324 5.08612 5.086 7.93252 5.086 11.4437C5.086 14.9549 7.9324 17.8013 11.4436 17.8013ZM11.4436 19.7086C16.0082 19.7086 19.7085 16.0083 19.7085 11.4437C19.7085 6.87915 16.0082 3.17883 11.4436 3.17883C6.87903 3.17883 3.17871 6.87915 3.17871 11.4437C3.17871 16.0083 6.87903 19.7086 11.4436 19.7086Z" fill="#30ABFC"/>
                <path fillRule="evenodd" clip-ruleRule="evenodd" d="M11.4437 20.9801C16.7105 20.9801 20.9801 16.7105 20.9801 11.4437C20.9801 6.17689 16.7105 1.90728 11.4437 1.90728C6.17689 1.90728 1.90728 6.17689 1.90728 11.4437C1.90728 16.7105 6.17689 20.9801 11.4437 20.9801ZM11.4437 22.8874C17.7639 22.8874 22.8874 17.7639 22.8874 11.4437C22.8874 5.12352 17.7639 0 11.4437 0C5.12352 0 0 5.12352 0 11.4437C0 17.7639 5.12352 22.8874 11.4437 22.8874Z" fill="#30ABFC"/>
