...
import backstoryImage from '@/images/backstory.svg'
...
const features = [
  {
    name: 'Easily invite friends & family',
    description:
      'Easily select individuals from your contacts list. You control who has access to the information.',
    icon: DeviceUserIcon,
    screen: InviteScreen,
  },
  {
  ...
  },
  {
    ...
    description:
      'Everyone who has been invited to your Convey event gets notified the immediatly when there is a new update.',
      ...
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
          ...
          <p className="mt-2 text-lg text-gray-400">
            We&apos;ve been there before. We were the parents with the daughter in an accident. We were fielding dozens of texts and calls. Repeating ourselves over and over. We&apos;ve been in your shoes and built this app to help.
          </p>
        </div>
      </Container>
